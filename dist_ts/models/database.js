...
async function setupDatabase() {
    try {
        ...
        await dbErrorHandler.safeDbOperation(() => sequelize.authenticate(), 'authenticate');
...
async function findProjectByPk(pk, options = {}) {
    return dbErrorHandler.safeDbOperation(() => Project.findByPk(pk, options), 'findProjectByPk', { pk, options });
}
// Enhanced findAll with error handling
async function findAllProjects(options = {}) {
    return dbErrorHandler.safeDbOperation(() => Project.findAll(options), 'findAllProjects', { options });
}
// Enhanced create with error handling
async function createProject(data) {
    return dbErrorHandler.safeDbOperation(() => Project.create(data), 'createProject', { data });
}
// Enhanced update with error handling
async function updateProject(data, options) {
    return dbErrorHandler.safeDbOperation(() => Project.update(data, options), 'updateProject', { data, options });
}
// Enhanced destroy with error handling
async function destroyProject(options) {
    return dbErrorHandler.safeDbOperation(() => Project.destroy(options), 'destroyProject', { options });
}
// Enhanced upsert with error handling
async function upsertProject(values, options) {
    return dbErrorHandler.safeDbOperation(() => Project.upsert(values, options), 'upsertProject', { values, options });
}
// Enhanced findOne with error handling
async function findOneProject(options) {
    return dbErrorHandler.safeDbOperation(() => Project.findOne(options), 'findOneProject', { options });
}
