        ...
        messages: [
          {
            role: 'system',
            content:
              'You are a specialized assistant that helps reformulate projects to make them more actionable and well-structured. ' +
        ...
        messages: [
          {
            role: 'system',
            content:
              'You are a specialized assistant that generates insightful project reports. ' +
          ...
          },
          {
            role: 'user',
            content:
              `Please generate a project report based on the following data:\n\n` +
